...
public class ZCPU extends Object implements Runnable {
    ...
    // Private variables
    private IStoryfile curStoryFile; // The storyfile we're using
    ...
    // the ZUserInterface.
    public void initialize(IStoryfile storyFile)
    {
        int i;
